...
# ==========================================
# ÍÎÂÎÅ: Ðàñ÷åò RSI (Èíäåêñ îòíîñèòåëüíîé ñèëû)
# ==========================================
def calculate_rsi(series, period=14):
    ...
    # Ñãëàæèâàíèå Óàéëäåðà (ñòàíäàðò TradingView)
...
# ÈÑÏÐÀÂËÅÍÈÅ: limit=1000 äëÿ èäåàëüíîãî "ïðîãðåâà" EMA200
def fetch(symbol, tf, limit=1000):
    try:
        ...
        df['rsi'] = calculate_rsi(df['close']) # <-- ÂÍÅÄÐÅÍ ÈÍÄÈÊÀÒÎÐ RSI
        return df.dropna()
    except: return None
